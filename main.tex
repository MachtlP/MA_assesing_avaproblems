...
%\includeonly{chapters/eulag_model,chapters/resultsQ3D}
%\includeonly{chapters/eulag_model,chapters/results3D}
...
\usepackage[
    ...
    style=authoryear, % apa, authoryear
  ]{biblatex}
...
\setcounter{figure}{0}
% ---- include tex-file:
\include{chapters/snowgrid_clustering}
\newpage
\thispagestyle{plain}
